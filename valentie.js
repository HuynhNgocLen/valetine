let messages = ["ĐỪNG MÀ", "EIU SUY NGHĨ LẠI ĐI", "EIU CHẮC CHỨ", "CHO EIU CƠ HỘI ĐÓ", "THẬT SỰ LÀ KHÔNG YÊU SAO", "CƠ HỘI CUỐI CÙNG CHO EIU ĐÓ", "ĐỪNG CHỌN 'NO' NỮA MÀ", "EIU LÀM TRÁI TIM ANH TAN VỠ RÙI💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">YAYAAAAAA ANH CŨNG YÊU EM TÍTTTT NHIỀU LẮM NÈK❤️</div>
    `;
    launchConfetti();
    startHeartRain();
}
